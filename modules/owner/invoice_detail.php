...
if(!isset($invoice_id) || !isExists('tbl_invoices','invoice_id',$invoice_id)){
...
$customer_id = getOne('tbl_orders','order_id',$order_id);

$customer_id = $customer_id['customer_id'];



$order_detail = "SELECT * FROM tbl_order_detail det INNER JOIN tbl_invoice_detail inv ON det.order_detail_id = inv.order_detail_id WHERE inv.invoice_id = '".$_GET['invoice_id']."' ";
...
// $invoice_detail = getWhere('tbl_invoice_detail','invoice_id',$invoice_id);



// owner details

$owner = getOne('tbl_owner','owner_id',1);

$owner_company_name  = $owner['owner_company_name'];

$owner_name  = $owner['owner_name'];

$owner_address  = $owner['owner_address'];

$owner_city_id  = $owner['owner_city_id'];

$owner_state_id  = $owner['owner_state_id'];

$owner_pincode  = $owner['owner_pincode'];

$owner_email  = $owner['owner_email'];

$owner_mobile  = $owner['owner_mobile'];

$owner_company_vat_tin_number = $owner['owner_company_vat_tin_number'];

$owner_company_cst_number = $owner['owner_company_cst_number'];

$owner_company_pan_number = $owner['owner_company_pan_number'];

$owner_bank_name = $owner['owner_bank_name'];

$owner_bank_account_number = $owner['owner_bank_account_number'];
...
$customer_detail = getWhere('tbl_customer','customer_id',$customer_id);
   ...
   <body class="fixed-left">
      ...
      <div id="wrapper">
         ...
         <div class="container">
          ...
          <!-- <a href="../../modules/owner/invoice.php?order_id=<?php echo $order_id; ?>"  class="btn btn-sm btn-default"><i class="fa fa-angle-left" style="font-size: 20px;"></i></a> -->
         ...
         <div class="row">
            ...
            <div class="col-md-10 col-xs-12 col-md-offset-1 table-border table-striped">
               ...
               <div id="background" style="z-index: -1;">
                  ...
                  <p id="bg-text" style="font-size: 120px;opacity: 0.2;cursor: default;z-index: 9999999999;user-select: none;transform: rotate(-40deg);position: absolute;top:420px;left: -30px; color: #ffb900"><b>nb</b></p>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 col-xs-6">
                    ...
                    <div class="row text-left">
                        ...
                        <?php if($invoice['consignee_same_as_customer'] == 1){ ?>     
                      ...
                      <?php }else{ ?>
                        ...
                        <div class="col-md-12 col-xs-12">
                          ...
                          <p> <?php echo $invoice['consignee']; ?> </p>
                      ...
                      <table class="table table-condensed">
                        ...
                        <tbody style="border: none;">
                          ...
                          <tr>
                            ...
                            <td width="50%" style="border: none;">Invoice No. <br><b><?php echo $invoice['invoice_number'] ?></b></td>

                            <td width="50%" style="border: none;">Dated <br><b><?php echo $invoice['invoice_date'] ?></b></td>

                          </tr>

                          <tr>

                            <td width="50%" style="border: none;">Delivery Note <br><b><?php echo $invoice['invoice_delivery_note'] ?></b></td>

                            <td width="50%" style="border: none;">Mode/Terms of Payment <br><b><?php echo $invoice['invoice_terms_of_payment'] ?></b></td>

                          </tr>

                          <tr>

                            <td width="50%" style="border: none;">Supplier's Ref. <br><b><?php echo $invoice['invoice_supplier_reference'] ?></b></td>

                            <td width="50%" style="border: none;">Other Reference(s) <br><b><?php echo $invoice['invoice_other_reference'] ?></b></td>

                          </tr>

                          <tr>

                            <td width="50%" style="border: none;">Buyer's Order No<br><b><?php echo $invoice['invoice_buyer_order_number'] ?></b></td>

                            <td width="50%" style="border: none;">Dated<br><b><?php echo $invoice['invoice_buyer_order_date'] ?></b></td>

                          </tr>

                          <tr>

                            <td width="50%" style="border: none;">Dispatch Document No. <br><b><?php echo $invoice['invoice_date'] ?></b></td>

                            <td width="50%" style="border: none;">Delivery Note Date<br><b><?php echo $invoice['invoice_delivery_note_date'] ?></b></td>

                          </tr>

                          <tr>

                            <td width="50%" style="border: none;">Dispatched Through <br><b><?php echo $invoice['invoice_dispatch_through'] ?></b></td>

                            <td width="50%" style="border: none;">Destination<br><b><?php echo $invoice['invoice_dispatch_destination'] ?></b></td>
                      ...
                      <table class="table table-condensed">
                        ...
                        <tbody>
                          ...
                          <?php if(isset($order_detail)){ ?>
                            ...
                            <tr>
                              ...
                              <td class="text-right">
                                ...
                                <?php 
                                  ...
                                  echo $rs['dispatch_quantity']." ".$product['product_packaging']; 
                              ...
                              <td class="text-center"><?php 
                                ...
                                $product_rate = $rs['dispatch_quantity'] * $rs['order_product_rate'] - ($rs['order_product_discount'] * $rs['order_product_rate'] * $rs['dispatch_quantity'] / 100);
                            ...
                            <?php $tax_total = 0; if(isset($tax_array['cgst_sgst'])){ foreach($tax_array['cgst_sgst'] as $rs){ ?>
                        ...
                        <thead>
                          ...
                          <?php } ?>
                            ...
                            <div class="col-md-6 col-xs-6" style="border: 1px solid rgba(0,0,0,0.2);margin-top: 5px;height: 100px;">
                              ...
                              <span style="position: absolute;right: 5px;">for nb FERTILIZERS</span>
