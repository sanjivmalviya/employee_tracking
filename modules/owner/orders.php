...
if(isset($_POST['submit'])){
   ...
   $orders = "SELECT * FROM tbl_orders ord INNER JOIN tbl_sales_person sales ON ord.sales_person_id = sales.sales_person_id WHERE ord.created_at BETWEEN '$start_date' AND '$end_date' ";
   
}else{
   
   $orders = "SELECT * FROM tbl_orders ord INNER JOIN tbl_sales_person sales ON ord.sales_person_id = sales.sales_person_id ";
                                       ...
                                       <?php if(isset($orders) && count($orders) > 0){ ?>
                                          ...
                                          <tr>
                                             ...
                                             <td><?php  
                                                ...
                                                echo $sales_person_name['sales_person_name'];
                                             ?></td>                                    
