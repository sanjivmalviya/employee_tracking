                     ...
                     <div class="col-sm-12">
                        ...
                        <div class="card-box">
                           ...
                           <div class="row">
                                 ...
                                 <table id="customers" class="table table-striped table-bordered table-condensed table-hover" style="margin-top: 50px; ">
                                    ...
                                    <tbody>
                                       ...
                                       <?php if(isset($customers) && count($customers) > 0){ ?>
                                          ...
                                          <tr>
                                             ...
                                             <td> <a href="detail.php?id=<?php echo $rs['customer_id']; ?>" title="More detail about customer"><?php echo $rs['customer_name']; ?></a> </td>
