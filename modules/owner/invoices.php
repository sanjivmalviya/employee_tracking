...
if(isset($_POST['submit'])){
   ...
   if($customer_id == ""){
      ...
      $invoices = "SELECT ord.order_number as order_number,ord.created_at as order_created_at,inv.invoice_number as invoice_number,inv.created_at as invoice_created_at,ord.customer_id as customer_id,ord.order_dispatch_status as dispatch_status,inv.invoice_id as invoice_id FROM tbl_invoices inv INNER JOIN tbl_orders ord ON inv.order_id = ord.order_id INNER JOIN tbl_sales_person sales ON ord.sales_person_id = sales.sales_person_id WHERE inv.created_at BETWEEN '$start_date' AND '$end_date' ";
   
   }else{
      
      $invoices = "SELECT ord.order_number as order_number,ord.created_at as order_created_at,inv.invoice_number as invoice_number,inv.created_at as invoice_created_at,ord.customer_id as customer_id,ord.order_dispatch_status as dispatch_status,inv.invoice_id as invoice_id FROM tbl_invoices inv INNER JOIN tbl_orders ord ON inv.order_id = ord.order_id INNER JOIN tbl_sales_person sales ON ord.sales_person_id = sales.sales_person_id WHERE ord.customer_id = '$customer_id' AND inv.created_at BETWEEN '$start_date' AND '$end_date' ";
   }
   
}else{
   
   $invoices = "SELECT ord.order_number as order_number,ord.created_at as order_created_at,inv.invoice_number as invoice_number,inv.created_at as invoice_created_at,ord.customer_id as customer_id,ord.order_dispatch_status as dispatch_status,inv.invoice_id as invoice_id FROM tbl_invoices inv INNER JOIN tbl_orders ord ON inv.order_id = ord.order_id INNER JOIN tbl_sales_person sales ON ord.sales_person_id = sales.sales_person_id";
