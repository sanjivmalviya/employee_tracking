...
$targets = "SELECT target.sales_person_id,SUM(target.sales_person_order_amount) as total_sales,COUNT(*) as total_orders FROM tbl_sales_person_target_detail target INNER JOIN tbl_sales_person sales ON target.sales_person_id = sales.sales_person_id WHERE sales.added_by = '$login_id' AND DATE(target.created_at) BETWEEN '$start_date' AND '$end_date' GROUP BY target.sales_person_id ORDER BY total_sales DESC ";
