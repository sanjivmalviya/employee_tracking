<?php
 ...
 $categories = getAll('tbl_category');
   ...
   if(isset($_POST['submit'])){
     ...
     $target_assigned = "SELECT target_category_id,COALESCE(SUM(target_category_amount),0) as target_assigned,sales_person_id FROM tbl_target WHERE YEAR(created_at) = '$year' AND MONTH(created_at) = '$month' AND target_category_id = '$category_id' GROUP BY target_category_id,sales_person_id";
                     ...
                     <div class="col-sm-12">
                        <div class="card-box">
                           ...
                           <div class="row" style="margin-top: 10px;">
                                 ...
                                 <?php if(isset($sales_person_name)){ ?>
                                    <h4 style="padding-right: 20px;"><i> <?php echo $sales_person_name; ?></b></i></h4>
                                 <?php } ?>
                                 <br> 
