...
if(isset($_POST['submit'])){
     ...
     if($_POST['employee_id'] == 0){
      ...
      $data = "SELECT * FROM tbl_employee_attendance WHERE DATE(date) BETWEEN '$date_from' AND '$date_to' ORDER BY id DESC ";
     
     }else{

      $employee_id = $_POST['employee_id'];
      $data = "SELECT * FROM tbl_employee_attendance WHERE DATE(date) BETWEEN '$date_from' AND '$date_to' AND employee_id = '".$employee_id."' ORDER BY id DESC ";
                        ...
                        <div class="card-box">
                           ...
                           <div class="row" style="margin-top: 10px;">
                            ...
                            <h5><?php if(isset($data)){ echo count($data)." Expense(s) found"; } ?></h5>
                                 ...
                                 <table id="attendance_report" class="table table-striped table-bordered table-condensed table-hover">
