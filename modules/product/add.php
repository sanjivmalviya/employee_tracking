                                             ...
                                             <select name="category_id" class="form-control select2">
                                                ...
                                                <?php if(isset($categories) && count($categories) > 0){ ?>
                                                  ...
                                                  <?php foreach($categories as $rs){ ?>
                                                      ...
                                                      <option <?php if(isset($edit_data['category_id']) && $edit_data['category_id'] == $rs['category_id']){ echo "selected";  } ?> value="<?php echo $rs['category_id']; ?>"><?php echo $rs['category_name']; ?></option>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" name="product_discount" parsley-trigger="change" class="form-control" id="product_discount" value="<?php if(isset($edit_data['product_discount'])){ echo $edit_data['product_discount']; }else{ echo '0'; } ?>">
