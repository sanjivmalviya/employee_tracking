                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <table style="width: 100%;" class="table-responsive table-bordered table-condensed table-hover">
                                          ...
                                          <tbody class="product_row">
                                            ...
                                            <td>
                                              <input type="texxt" class="form-control discount" name="product_discount[]" id="product_discount_0" data-id="0" readonly="">
                                            </td>
                                            <td>
                                              <input type="number" class="form-control amount" name="product_amount[]" id="product_amount_0" readonly="" data-id="0">
                                            </td>
                                            <td class="text-center"><i class="fa fa-close close" id="0"></i></td>
                                          ...
                                          <tr><td colspan="6" class="text-right">Grand Total (Including GST) : </td><td colspan="2"><span id="total">0</span> <input type="hidden" id="total_val"></td>
  <!-- 
                                          <tr>
                 ...
                 // Calculate GST
                  ...
                  if(gst_type=='1'){
                      ...
                      product_gst_amount.forEach(function(val){
                        ...
                        html_gst += '<tr><td colspan="6" class="text-right">SGST('+cgst_sgst+' %) :  </td><td colspan="2">'+cgst_sgst_val+'</td></tr>';
