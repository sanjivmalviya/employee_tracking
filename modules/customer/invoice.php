   ...
   <body class="fixed-left">
      ...
      <div id="wrapper">
         ...
         <div class="container">
          ...
          <a href="../../modules/customer/view_order.php" class="btn btn-sm btn-default"><i class="fa fa-angle-left" style="font-size: 20px;"></i></a>
              ...
              <tbody>
                ...
                <?php if(isset($invoices)){ ?>
                   ...
                   <!--      <td><?php echo $rs['invoice_delivery_note']; ?></td>
                        ...
                        <td class="text-center"><a href="invoice_detail.php?invoice_id=<?php echo $rs['invoice_id']; ?>" class="btn btn-primary btn-xs"><i class="fa fa-print"></i> Print Invoice</a></td>
                      </tr>
